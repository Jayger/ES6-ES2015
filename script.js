...
isFullAge5(1990, 1999, 1965, 2019, 1984);

// ES6
function isFullAge6(...years) {
    years.forEach(cur => (2019 - cur) >= 18);
}

isFullAge6(1990, 1999, 1965, 2019, 1984);
...
isFullAge6(16, 1990, 1999, 1965, 2019, 1984);
*/
...
question.set(true, 'Correct Answer! xD');
